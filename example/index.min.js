var stream = (function (exports) {
	...
	class CustomElement {
	  ...
	  on(name, callback) {
	    var withoutOptions = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
	    var {
	      target
	    } = this;
	...
	class IdGenerator {
	  ...
	  genId() {
	    ...
	    var newId = "".concat(prefix).concat(serialNumber.toString(16));
	    this.serialNumber++;
	    return newId;
	  }
	...
	class NameGenerator {
	  ...
	  genName() {
	    ...
	    var newName = "".concat(prefix).concat(serialNumber.toString(16));
	    this.serialNumber++;
	    return newName;
	  }
	  ...
	  forEachAsync(callback) {
	    ...
	    return forEachAsync(this._indices, /*#__PURE__*/function () {
	      var _ref = _asyncToGenerator(function* (id, key, index) {
	        ...
	        return object && (yield callback(object, id, index));
	      });
